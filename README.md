...
I employ a difference-in-differences (DiD) framework to isloate the casual effect of Hurricanes Irma and Maria (2017) on housing prices in San Juan, PR by comparing the outcome variables in San Juan, PR and Miami, FL before and after the 2017 storms. By implementing two forms of the model (with and without fixed effects), the analysis disentangles storm-driven impacts on housing prcies from broader economic factors.
## Research Question
